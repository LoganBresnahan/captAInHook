...
- env vars: `CAPTAINHOOK_LOG`, `CAPTAINHOOK_LOG_STDERR`, `CAPTAINHOOK_HARNESS_DIR`, `CAPTAINHOOK_PROBE`
- runtime home: `~/.captainHook/` — JSONL logs in `logs/`, user harness overrides in `harnesses/`
