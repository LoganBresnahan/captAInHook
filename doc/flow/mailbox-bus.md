...
| trail events | `mail.append`, `mail.torn`, `mail.lockBusy`, `mail.expire`, `mail.deliver`, `mail.cursorAdvance`, `mail.cursorReanchor`, `mail.cursorRefuse`, `mail.cursorVanished` |
